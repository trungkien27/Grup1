...
<body>
	<div class="container" style="margin-top: 10px;">
		<div class="card">
			...
			<div class="card-body">
				<a href="add-category.php"><button class="btn btn-success">Add Category</button></a>
	...
	foreach ($categoryList as $item) {
		echo '
			<tr>
				<td>'.(++$count).'</td>
				<td>'.$item['title'].'</td>
				<td><a href="add-category.php?id='.$item['id'].'"><button class="btn btn-warning">Edit</button></a></td>
