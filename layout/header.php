...
<nav class="navbar navbar-expand-lg heading">
	...
	<ul>
		...
		<li class="dropdown">
  			<a class="dropdown-toggle" href="../admin/list-product.php" id="navbardrop" data-toggle="dropdown">sản phẩm</a>
		      	<div class="dropdown-menu" style="border: none; font-weight: bold;">
			        ...
			        <a style="font-weight: bold;" class="dropdown-item" href="#">Sản phẩm gắn móng </a>
